    ...
    try {
      ...
      if (result.success) {
        setToast({
          show: true,
          variant: "success",
          title: "Úspešné pripojenie",
          message: `Počet eventov: ${result.events_count}`,
        });
      } else {
        setToast({
          show: true,
          variant: "error",
          title: "Neúspešné pripojenie",
      ...
      setToast({
        ...
        message: err instanceof Error ? err.message : "Neznáma chyba",
      });
    }
  };
  ...
  return (
    <div>
      ...
      >
        ...
        >
          Konfigurácia Arena inštancií, z ktorých sa budú synchronizovať dáta.
          Môžete pridať viacero trénerských Arena Docker inštancií.
        </p>
