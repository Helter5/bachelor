  ...
  return (
    ...
    `}>
      ...
      <div className={`p-4 ${isDarkMode ? 'border-t border-white/5' : 'border-t border-gray-200'}`}>
        ...
        <button
          onClick={onLogout}
          className={`w-full flex items-center justify-start px-4 py-2 rounded-md text-sm font-medium transition-all ${
            isDarkMode
              ? 'bg-transparent text-slate-300 border border-white/10 hover:bg-white/5'
