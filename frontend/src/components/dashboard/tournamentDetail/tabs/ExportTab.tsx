      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className={`rounded-lg p-6 ${isDarkMode ? 'bg-[#0f172a]/50 shadow-md backdrop-blur-sm' : 'bg-gray-50 border border-gray-200'}`}>
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h4 className={`font-bold text-lg ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Zoznam tímov</h4>
              <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                Export všetkých tímov turnaja ({teams.length} tímov)
              </p>
            </div>
          </div>
        ...
        <div className={`rounded-lg p-6 ${isDarkMode ? 'bg-[#0f172a]/50 shadow-md backdrop-blur-sm' : 'bg-gray-50 border border-gray-200'}`}>
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h4 className={`font-bold text-lg ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Zoznam atlétov</h4>
              <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                Export všetkých atlétov turnaja ({athletes.length} atlétov)
              </p>
            </div>
          </div>
          <div className="flex gap-3 mt-4">
