type IconPreset = 'person' | 'team' | 'weight' | 'document' | 'calendar' | 'chart'

const iconPaths: Record<IconPreset, string> = {
...
export function EmptyState({ isDarkMode, icon = 'document', title, description, className }: EmptyStateProps) {
  return (
